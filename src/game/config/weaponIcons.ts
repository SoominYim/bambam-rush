export const WEAPON_ICONS = {
  ...
  PHASE_MARK_LANCE: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="phaseSpear" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#6f45ff"/><stop offset="50%" stop-color="#b88cff"/><stop offset="100%" stop-color="#f2e9ff"/></linearGradient></defs><circle cx="18" cy="32" r="8" fill="none" stroke="#7b57ff" stroke-width="3" opacity="0.85"/><path d="M20 32L44 32" stroke="url(#phaseSpear)" stroke-width="5" stroke-linecap="round"/><path d="M50 32L42 27L42 37Z" fill="#f2e9ff" stroke="#7b57ff" stroke-width="1.5"/><circle cx="30" cy="32" r="2.5" fill="#ffffff"/></svg>`,
