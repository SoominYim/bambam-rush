export const WEAPON_ICONS = {
  ...
  // W11: 박쥐 소환
  SUMMON_BAT: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M32 38C26 38 20 28 12 30C12 40 24 48 32 52C40 48 52 40 52 30C44 28 38 38 32 38Z" fill="#4B0082"/><circle cx="28" cy="36" r="1" fill="#D00"/><circle cx="36" cy="36" r="1" fill="#D00"/></svg>`,
  ...
  // W14: 차크람
  CHAKRAM: `<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><circle cx="32" cy="32" r="20" fill="none" stroke="#C0C0C0" stroke-width="8"/><circle cx="32" cy="32" r="24" stroke="#FFF" stroke-width="1" fill="none"/><path d="M32 8L36 16H28L32 8Z" fill="#C0C0C0"/><path d="M32 56L36 48H28L32 56Z" fill="#C0C0C0"/><path d="M8 32L16 28V36L8 32Z" fill="#C0C0C0"/><path d="M56 32L48 28V36L56 32Z" fill="#C0C0C0"/></svg>`,
